...
谷仓
- API version: 1.0.0
  - Build date: 2026-01-05T18:22:56.415562500+08:00[Asia/Shanghai]
...
import org.dromara.threepart.logistics.goodcang.model.*;
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**publicOpenBaseDataGetShippingMethodPost**](docs/DefaultApi.md#publicOpenBaseDataGetShippingMethodPost) | **POST** /public_open/base_data/get_shipping_method | 获取物流产品


## Documentation for Models

 - [GetShippingMethodDataResponse](docs/GetShippingMethodDataResponse.md)
 - [GetShippingMethodRequest](docs/GetShippingMethodRequest.md)
 - [GetShippingMethodResponse](docs/GetShippingMethodResponse.md)
